# User interface for METEOR Shiny application
...
ui <- dashboardPage(
  ...
  # Dashboard header
  dashboardHeader(
    title = "METEOR - AMR Analysis",
    tags$li(class = "dropdown",
            tags$a(href = "https://github.com/yourusername/metero", 
                   target = "_blank", 
                   tags$img(src = "meteor_logo.png", height = "30px"),
                   "v0.1.0"))
  ),
    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            title = "Welcome to METEOR", status = "primary", solidHeader = TRUE,
            p("METEOR is an integrated toolkit for analyzing Antimicrobial Resistance (AMR) data."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            title = "METEOR Help", status = "primary", solidHeader = TRUE,
            tabsetPanel(
              tabPanel("Overview", 
                       includeMarkdown(system.file("shiny-apps/meteor/www/help_overview.md", package = "metero"))),
              tabPanel("Data Import", 
                       includeMarkdown(system.file("shiny-apps/meteor/www/help_data_import.md", package = "metero"))),
              tabPanel("Analysis", 
                       includeMarkdown(system.file("shiny-apps/meteor/www/help_analysis.md", package = "metero"))),
              tabPanel("Visualization", 
                       includeMarkdown(system.file("shiny-apps/meteor/www/help_visualization.md", package = "metero"))),
              tabPanel("FAQ", 
                       includeMarkdown(system.file("shiny-apps/meteor/www/help_faq.md", package = "metero")))
            )
          )
        )
      )
